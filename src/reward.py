...
class RewardConfig:
    ...
    # ── Smooth driving ─────────────────────────────────────────────────
    # Yaw jerk penalty discourages oscillation/zigzagging. At -2.0 it
    # competes with forward progress (~+1.0/step at typical speed) but
    # does not dominate — small course corrections are still affordable.
